            ...
            {hasError ? (
                <div className="min-h-screen bg-gradient-to-br from-slate-950 via-blue-950 to-indigo-950 flex items-center justify-center p-8">
                    <Card className="max-w-md mx-auto bg-red-900/20 border-red-500/50">
                        <CardHeader>
                            <CardTitle className="text-red-400">Error Loading Pricing</CardTitle>
                        </CardHeader>
                        <CardContent>
                            <p className="text-white mb-4">There was an issue loading the pricing configuration:</p>
                ...
                <div className="min-h-screen bg-gradient-to-br from-slate-950 via-blue-950 to-indigo-950 relative overflow-hidden">
                        ...
                        <div className="container mx-auto px-4">
                            <div className="text-center max-w-4xl mx-auto">
                                ...
                                <h1 className="text-4xl md:text-6xl font-bold text-white mb-6">
                                    ...
                                    <span className="bg-gradient-to-r from-blue-400 to-purple-400 bg-clip-text text-transparent"> Build</span>
                                </h1>
                                ...
                                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 max-w-2xl mx-auto">
                                    <div className="glassmorphism p-4 rounded-lg">
                                        <div className="text-2xl font-bold text-blue-400">{WEBSITE_TYPES.length}+</div>
                                        <div className="text-sm text-gray-400">Website Types</div>
                                    </div>
                                    <div className="glassmorphism p-4 rounded-lg">
                                        <div className="text-2xl font-bold text-purple-400">3</div>
                                        <div className="text-sm text-gray-400">Tier Options</div>
                                    </div>
                                    <div className="glassmorphism p-4 rounded-lg">
                                        <div className="text-2xl font-bold text-green-400">{pricingConfig.global_addons.length}+</div>
                                        <div className="text-sm text-gray-400">Add-ons</div>
                                    </div>
                                    <div className="glassmorphism p-4 rounded-lg">
                                        <div className="text-2xl font-bold text-yellow-400">15%</div>
                                        <div className="text-sm text-gray-400">Launch Discount</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                                                        ...
                                                        return (
                                                            ...
                                                            >
                                                                ...
                                                                <CardHeader className="text-center">
                                                                    <div className="mb-4">
                                                                        {tierKey === 'essential' && <Zap className="w-8 h-8 mx-auto text-green-400" />}
                                                                        {tierKey === 'professional' && <Sparkles className="w-8 h-8 mx-auto text-purple-400" />}
                                                                        {tierKey === 'ultimate' && <Crown className="w-8 h-8 mx-auto text-yellow-400" />}
                                                                    </div>
                    ...
                    {showMobileCalculator && (
                        <div className="lg:hidden fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-end">
                            <div className="w-full max-h-[80vh] bg-slate-900 rounded-t-2xl p-6 overflow-y-auto">
                    ...
                    {showMobilePlatforms && (
                        <div className="lg:hidden fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-end">
                            <div className="w-full max-h-[60vh] bg-slate-900 rounded-t-2xl p-6">
                                <div className="flex justify-between items-center mb-4">
                                    <h3 className="text-lg font-semibold text-white">Platform Options</h3>
                                    <Button
                                        variant="ghost"
                                        size="sm"
