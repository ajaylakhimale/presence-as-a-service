-- Plan-specific onboarding forms table
CREATE TABLE IF NOT EXISTS plan_onboarding_forms (
  id UUID DEFAULT gen_random_uuid() PRIMARY KEY,
  
  -- Plan Information
  plan_type VARCHAR(50) NOT NULL, -- 'basic', 'professional', 'business-standard', 'business-pro', 'enterprise-platform', 'enterprise-custom', 'connected-launch', 'connected-pro', 'connected-enterprise'
